...
industry_category_df = DataAPI.EquIndustryGet(secID=u"",
                                              ...
                                              industryID=u"",
                                              industryID1=u"",
                                              industryID2=u"", industryID3=u"", intoDate=u"20210101", equTypeID=u"",
                                              field=u"", pandas="1")
...
industry_category_dict = dict(
    zip(industry_category_df['ticker'].tolist(), industry_category_df['industryName1'].tolist()))

# 交易日历
beginDate = u"20210101"
endDate = u"20210301"
canlendar_df = DataAPI.TradeCalGet(exchangeCD=u"XSHG", beginDate=beginDate, endDate=endDate, isOpen=u"1", field=u"",
                                   pandas="1")
