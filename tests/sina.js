function d(t) {
    var e, i, n, r, a, o, s, l = (arguments, 864e5),
        u = 7657,
        c = [],
        h = [],
        d = ~(3 << 30),
        ...
        S = function () {
            ...
            for (
                r.d = w([18], [1])[0] - 1,
                    ...
                    t = 0;
                o = {d: 1},
                y() && (a = w([3])[0], 0 == a ? o.d = w([6])[0] : 1 == a ? (r.d = w([18])[0], o.d = 0) : o.d = a),
                    l = {day: x(o.d)},
                y() && (r.ld += N()),
                    a = w([3 * r.ld], [1]),
                    r.cd += a[0],
            ...
            // 观测初始参数
            console.log("初始参数: d=", r.d, "p=", r.p, "ld=", r.ld, "cd=", r.cd, "c=", r.c);
            // 观测每个解码出来的日期
            i.forEach(function (item, idx) {
                console.log("date[" + idx + "]:", item.day.toISOString().slice(0, 10));
            });
        ...
        _ = function () {
            ...
            for (r.m = m.pow(10, r.pp), s >= 1 ? (a = w([3, 3]), r.c = a[0], a = a[1]) : (a = 5, r.c = 2), r.pc = w([6 * a])[0], h.pc = r.pc / r.m, r.cp = r.pc, r.da = 0, r.sa = r.sv = 0, t = 0; !(e >= n) && (e != n - 1 || 7 & (r.c ^ t)); t++) {
                for (l = {},
                         o = {},
                         f = r.tv ? y() : 1, i = 0; 3 > i; i++) if (p = ["v", "p", "a"][i], (f ? y() : 0) && (a = N(), r["l" + p] += a), u = "v" == p && r.rv ? y() : 1, a = w([3 * r["l" + p] + ("v" == p ? 7 * u : 0)], [!!i])[0] * (u ? 1 : 100), o[p] = a, "v" == p) {
        ...
        k = function () {
            ...
            for (r.l = 0, n = -1, r.d = w([18])[0] - 1, i = w([18])[0]; r.d < i;) e = x(1),
                0 >= n ? (y() && (r.l += N()), n = w([3 * r.l], [0])[0] + 1, t || (t = [e], n--)) : t.push(e),
                n--;
            return t
        };
