...
from quant1x.data.meta.code import correct_security_code
from quant1x.data.meta.calendar import prev_trading_day, last_trading_day
...
def lazy_load_margin_trading():
    ...
    with _margin_trading_cache_mutex:
        ...
        last_trading_day_ts = last_trading_day()
