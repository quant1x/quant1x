...
impl Timestamp {
    ...
    pub fn from_date(
        ...
        let naive_time = naive_date.and_hms_milli_opt(hour, minute, second, millisecond)?;
    ...
    /// 从YYYYMMDD整数创建时间戳
    pub fn from_yyymmdd_u32(date: u32) -> Self {
...
mod tests {
    ...
    fn test_parse_flexibility_and_tolerance() {
        ...
        println!(
            "用户场景1 - 只关注时间: parse_time('14:30:45') -> {}",
            time_only.to_string()
        );
        ...
        println!(
            "用户场景2 - 完整日期时间给parse_time: parse_time('2022-06-15 14:30:45') -> {}",
            full_datetime.to_string()
        );
