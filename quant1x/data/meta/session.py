...
_ts_today_session_once = RollingOnce(name='sessions_init', cron=GLOBAL_CRON_EXPR_DAILY_INIT)
...
_ts_today_init_once = RollingOnce(name='today_init', cron=GLOBAL_CRON_EXPR_DAILY_INIT)
