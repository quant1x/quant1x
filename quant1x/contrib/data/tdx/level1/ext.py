...
class Synchronize2(protocol.BaseMessage):
    ...
    """
    def __init__(self):
        super().__init__(Command.EXT_SYNCHRONIZE2)
        self.reply = ''
        self.success: bool = False
...
class InstrumentQuote1(protocol.BaseMessage):
    ...
    def __init__(self, market, ticker: str):
        super().__init__(Command.EXT_INSTRUMENT_QUOTE_X1)
        self.market = market
        self.ticker = ticker
        self.reply = []
...
class InstrumentQuote2(protocol.BaseMessage):
    ...
    def __init__(self, futures: list[tuple[int, str]]):
        super().__init__(Command.EXT_INSTRUMENT_QUOTE_X2)
        self.reply = []
...
class TodoCmd0X2459(protocol.BaseMessage):
    ...
    """
    def __init__(self, market, ticker: str):
        super().__init__(Command.EXT_TODO_2459)
        self.ticker = ticker
        self.reply = []
...
class TodoCmd0X2488(protocol.BaseMessage):
    ...
    def __init__(self, ticker: str):
        super().__init__(Command.EXT_XDXR_INFO)
        self.ticker = ticker
        self.reply = []
...
class TodoCmd0X2489(protocol.BaseMessage):
    ...
    def __init__(self, market:int, ticker: str):
        super().__init__(Command.EXT_TODO_2489)
        self.market = market
        self.ticker = ticker
        self.bar_type = 4
        self.unknown1 = 1
...
class Futures_Quotes(protocol.BaseMessage):
    """期货行情"""
    def __init__(self, futures: list[tuple[int, str]]):
        super().__init__(Command.EXT_FUTURES_QUOTES)
        self.reply = []
        self.futures = futures
        length = len(futures)
        if length <= 0:
