#pragma once
#ifndef QUANT1X_CONTRB_DATA_TDX_TRANSACTION_DATA_H
#define QUANT1X_CONTRB_DATA_TDX_TRANSACTION_DATA_H 1
...
#pragma pack(pop)  // 恢复默认对齐方式
    ...
    struct Transaction : public BaseMessage<Transaction> {
        ...
        Transaction(const meta::Instrument &inst, u16 offset, u16 size) : BaseMessage<Transaction>() {
...
#endif //QUANT1X_CONTRB_DATA_TDX_TRANSACTION_DATA_H
