...
from quant1x.data.market import Instrument, InstrumentType, detect_symbol
from quant1x.data import adapter, config
...
def checkout_transaction_data(security_code: str, feature_date: Timestamp, ignore_previous_data: bool) -> List[Transaction]:
    """
    获取指定证券在特定日期的逐笔交易数据
