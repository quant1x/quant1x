...
pub const BASE_TRANSACTION: crate::cache::Kind = crate::cache::PLUGIN_MASK_BASE_DATA | (BASE_KIND + 4);
pub const BASE_MINUTES: crate::cache::Kind = crate::cache::PLUGIN_MASK_BASE_DATA | (BASE_KIND + 5);
pub const BASE_QUARTERLY_REPORTS: crate::cache::Kind = crate::cache::PLUGIN_MASK_BASE_DATA | (BASE_KIND + 6);
pub const BASE_SAFETY_SCORE: crate::cache::Kind = crate::cache::PLUGIN_MASK_BASE_DATA | (BASE_KIND + 7);
pub const BASE_WIDE_KLINE: crate::cache::Kind = crate::cache::PLUGIN_MASK_BASE_DATA | (BASE_KIND + 8);
pub const BASE_PERFORMANCE_FORECAST: crate::cache::Kind = crate::cache::PLUGIN_MASK_BASE_DATA | (BASE_KIND + 9);
pub const BASE_CHIP_DISTRIBUTION: crate::cache::Kind = crate::cache::PLUGIN_MASK_BASE_DATA | (BASE_KIND + 10);
pub const BASE_MINUTE_KLINE: crate::cache::Kind = crate::cache::PLUGIN_MASK_BASE_DATA | (BASE_KIND + 11);
