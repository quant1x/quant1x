...
var sseRules = []CodeRule{
	...
	{"510", SecurityETF, "交易型开放式指数证券投资基金", "标的指数为沪市指数、跨市场指数或跨境指数"},
	{"511", SecurityETF, "债券交易型指数基金 / 交易型货币基金", "511000-511299 用于单市场债券（沪）ETF；511300-511599 用于现金申赎类债券ETF；511600-511999 用于交易型货币市场基金"},
	{"512", SecurityETF, "交易型开放式指数证券投资基金", "标的指数为跨市场指数"},
	{"513", SecurityETF, "交易型开放式指数证券投资基金", "标的指数为跨境指数"},
	{"515", SecurityETF, "交易型开放式指数证券投资基金", "标的指数为跨市场指数"},
	{"516", SecurityETF, "交易型开放式指数证券投资基金", "标的指数为跨市场指数"},
	{"517", SecurityETF, "跨市场股票ETF", "517000-517999 用于跨市场股票（沪港深京）ETF"},
	{"518", SecurityETF, "商品交易型开放式证券投资基金", "商品类 ETF"},
	{"519", SecurityFund, "开放式基金申赎/认购", "519*** 系列用于开放式基金的申赎/认购/跨市场转托管/分红/转换等；5198** 用于实时申赎货币基金（实时申赎）"},
	{"520", SecurityETF, "跨境ETF", "520500-520999 用于跨境 ETF"},
	{"521", SecurityFund, "开放式基金认购", "对应519*** 系列的认购业务"},
	{"522", SecurityFund, "开放式基金跨市场转托管", "对应519*** 系列的跨市场转托管业务"},
	{"523", SecurityFund, "开放式基金分红", "对应519*** 系列的分红业务"},
	{"524", SecurityFund, "开放式基金基金转换", "对应519*** 系列的基金转换业务"},
	{"530", SecurityETF, "交易型开放式指数证券投资基金", "标的指数为沪市指数"},
	{"550", SecurityFund, "基金", ""},
	{"560", SecurityETF, "交易型开放式指数证券投资基金", "标的指数为跨市场指数"},
	{"561", SecurityETF, "交易型开放式指数证券投资基金", "标的指数为跨市场指数"},
	{"562", SecurityETF, "交易型开放式指数证券投资基金", "标的指数为跨市场指数"},
	{"563", SecurityETF, "交易型开放式指数证券投资基金", "标的指数为跨市场指数"},
	{"580", SecurityWarrant, "权证", "含股改权证、公司权证"},
	{"582", SecurityWarrant, "权证行权", "用于权证行权/行权相关代码"},
	{"588", SecurityETF, "科创板ETF", "588000-588299 单市场（科创板）ETF；588300-588699 跨市场（含科创板）ETF；588700-588999 单市场（科创板）ETF"},
	{"5", SecurityETF, "基金/REITs/权证", "首位 5：基金、公募 REITs、权证"},
	...
	{"709", SecurityOther, "按市值配售配股", "不再增用"},
	{"713", SecurityOther, "可转债申购", "对应605***"},
	{"714", SecurityOther, "可转债申购配号", "对应605***"},
	{"715", SecurityOther, "可转债持股配债", "对应605***"},
	{"716", SecurityOther, "增发款", "对应605***"},
	{"717", SecurityOther, "配股", "对应605***"},
	{"718", SecurityOther, "科创板可转债申购", "对应118000-118499"},
	{"719", SecurityOther, "科创板可转债申购配号", "对应118000-118499"},
	{"726", SecurityOther, "科创板可转债配债", "对应118000-118499"},
	{"730", SecurityIPO, "新股申购", "新股申购/网上申购"},
	{"731", SecurityOther, "持股增发", "对应600***"},
	{"732", SecurityOther, "网上按市值申购或增发", "对应603***"},
	{"733", SecurityOther, "可转换公司债券申购", "对应600***"},
	{"734", SecurityOther, "增发款", "对应603***"},
	{"735", SecurityOther, "基金申购", "不再增用"},
	{"736", SecurityOther, "网上按市值申购或增发配号", "对应603***"},
	{"737", SecurityOther, "按市值配售", "不再增用"},
	{"738", SecurityOther, "网络投票", "对应600***（技术调整不再增用）"},
	{"739", SecurityOther, "按市值配售申购", "不再增用"},
	{"740", SecurityOther, "增发款", "对应600***"},
	{"741", SecurityOther, "网上按市值申购或增发配号", "对应600***"},
	{"742", SecurityOther, "配股", "对应603***"},
	{"743", SecurityOther, "可转换公司债券申购款", "对应600***"},
	{"744", SecurityOther, "可转换公司债券配号", "对应600***"},
	{"745", SecurityOther, "基金申购款", "不再增用"},
	{"746", SecurityOther, "基金申购配号", "不再增用"},
	{"747", SecurityOther, "按市值配售", "不再增用"},
	{"748", SecurityOther, "按市值配售", "不再增用"},
	{"749", SecurityOther, "按市值配售配号", "不再增用"},
	{"750", SecurityOther, "国债承销发行", ""},
	{"751", SecurityOther, "国债预发行及债券分销", "751000-751199用于国债分销；751200-751399用于政策性银行金融债券分销；751400-751599用于地方政府债券网上分销；751600-751799用于国债分销；751800-751809用于利率招标国债预发行交易；751810-751819用于价格招标国债预发行交易；751850-751899用于面向专业投资者公开发行公司债券网上分销；751900-751969用于地方政府债券网上分销；751970-751999用于公司债券及企业债分销"},
	{"752", SecurityOther, "网络投票", "对应603***，由于技术调整不再增用"},
	{"753", SecurityOther, "可转换公司债券持股配债", "对应603***"},
	{"754", SecurityOther, "可转换公司债券申购", "对应603***"},
	{"755", SecurityOther, "可转换公司债券申购款", "对应603***"},
	{"756", SecurityOther, "可转换公司债券配号", "对应603***"},
	{"758", SecurityOther, "可交换公司债券网上发行配号", "758000-758099 用于可交换公司债券网上发行配号"},
	{"759", SecurityOther, "可交换公司债券网上发行申购", "759000-759099 用于可交换公司债券网上发行申购"},
	{"760", SecurityOther, "配股", "对应601***"},
	{"762", SecurityOther, "职工股配股", "对应601***"},
	{"764", SecurityOther, "可转换公司债券持股配债", "对应601***"},
	{"770", SecurityOther, "公开发行优先股申购", "对应330***"},
	{"771", SecurityOther, "公开发行优先股配股、配售", "对应330***"},
	{"772", SecurityOther, "公开发行优先股申购款", "对应330***"},
	{"773", SecurityOther, "公开发行优先股申购配号", "对应330***"},
	{"780", SecurityOther, "网上按市值申购或增发", "对应601***"},
	{"781", SecurityOther, "持股增发", "对应601***"},
	{"783", SecurityOther, "可转换公司债券申购", "对应601***"},
	{"785", SecurityOther, "科创板股票配股", "对应688***"},
	{"786", SecurityOther, "科创板上市公司股东以配售方式减持股份业务（简称科创板配售业务）", "786000-786899用于科创板股票配售；786900-786999用于科创板存托凭证配售"},
	{"787", SecurityOther, "科创板股票网上申购", "对应688***"},
	{"788", SecurityOther, "网络投票", "对应601***（技术调整不再增用）"},
	{"789", SecurityOther, "科创板股票网上申购配号", "对应688***"},
	{"790", SecurityOther, "增发款", "对应601***"},
	{"791", SecurityOther, "网上按市值申购或增发配号", "对应601***"},
	{"793", SecurityOther, "可转换公司债券申购款", "对应601***"},
	{"794", SecurityOther, "可转换公司债券配号", "对应601***"},
	{"795", SecurityOther, "科创板存托凭证网上申购", "对应689***"},
	{"796", SecurityOther, "科创板存托凭证网上申购配号", "对应689***"},
...
var bjseRules = []CodeRule{
	...
	{"821", SecurityBond, "优先股", "优先股票首三位代码为820"},
