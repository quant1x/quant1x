...
// 		if len(symbol) >= 5 {
// 			return string(ExchangeHKEX) + symbol[:5]
// 		}
// 		return string(ExchangeHKEX) + symbol
// 	case ExchangeIdBeiJing:
// 		if len(symbol) >= 6 {
// 			return string(ExchangeBSE) + symbol[:6]
// 		}
// 		return string(ExchangeBSE) + symbol
// 	case ExchangeIdShenZhen:
// 		if len(symbol) >= 6 {
