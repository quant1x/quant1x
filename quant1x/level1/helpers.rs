...
pub fn default_base_unit(_market_id: i32, code: &str) -> f64 {
    ...
    if code.starts_with("60") || code.starts_with("68") || code.starts_with("00") || code.starts_with("30") || code.starts_with("39") {
        100.0
...
pub fn assert_index_by_market_and_code(market_id: i32, symbol: &str) -> bool {
    ...
    if market_id == 1 && (symbol.starts_with("000") || symbol.starts_with("880") || symbol.starts_with("881")) {
        return true;
    }
